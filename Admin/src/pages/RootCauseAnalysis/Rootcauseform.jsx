                  ...
                  <div className="wizard clearfix">
                    ...
                    <div className="content clearfix">
                      <TabContent activeTab={activeTab} className="body">
                        ...
                        <TabPane tabId={3}>
                          <Form>
                            <h5 className="mb-3 text-primary">Bölüm 3: Kök Neden İncelemesi</h5>
                            ...
                            <div className="mb-4 p-4 bg-light border rounded">
                                <div className="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <h6 className="mb-1 fw-bold">Yapay Zeka Analiz Süreci</h6>
                                        <p className="mb-0 text-muted small">
                                            {isAnalyzing ? '⏳ Analiz Devam Ediyor...' : '✅ Analiz Tamamlandı'}
                                        </p>
                                    </div>
                                </div>
                                
                                <div className="d-flex flex-column gap-3">
                                    <div className="d-flex align-items-start bg-white p-3 rounded border">
                                        <div className="fs-4 me-3">📄</div>
                                        <div>
                                            <h6 className="mb-1 small fw-semibold">Rapor Metni Okunuyor...</h6>
                                            <p className="mb-0 text-muted" style={{fontSize: '0.85rem'}}>
                                                Açıklama netliği ve eksiksizliği için taranıyor.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-flex align-items-start bg-white p-3 rounded border">
                                        <div className="fs-4 me-3">🔧</div>
                                        <div>
                                            <h6 className="mb-1 small fw-semibold">Ekipman Tanımlandı</h6>
                                            <p className="mb-0 text-muted" style={{fontSize: '0.85rem'}}>
                                                Bahsettiğiniz ekipmanları tespit ettim. Detaylı analiz için kullanılacak.
                                            </p>
                                        </div>
                                    </div>
                                    
                                    <div className="d-flex align-items-start bg-white p-3 rounded border border-warning">
                                        <div className="fs-4 me-3">⚠️</div>
                                        <div>
                                            <h6 className="mb-1 small fw-semibold">Güvenlik Endişesi Tespit Edildi</h6>
                                            <p className="mb-0 text-muted" style={{fontSize: '0.85rem'}}>
                                                Belirttiğiniz kritik risk faktörleri kök neden analizinde dikkate alınacak.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mb-4 position-relative p-3 bg-light border border-primary rounded">
                                <div className="d-flex justify-content-between align-items-center mb-2">
                                    <Label className="fw-bold mb-0">Olay Detayları (Ne oldu, Nasıl oldu, Neyin yanlış gittiği): *</Label>
                                    <Badge color="primary">AI Analiz Kaynağı</Badge>
                                </div>
                                <Alert color="info" className="py-2 px-3 mb-2 small">
                                    <i className="bx bx-info-circle me-1"></i>
                                    <strong>AI İpucu:</strong> Kök Neden Analizi'nin (Bölüm 4) kalitesi burada sağladığınız detaylara bağlıdır. Sıraları, ekipmanı ve eylemleri belirtin.
                                </Alert>
                                <Input 
                                    type="textarea" 
                                    rows="8" 
                                    ...
                                    placeholder="Örn: Operatör makine çalışırken güvenlik koruyucusunu açtı..." 
                                />
                            </div>
                            {/* ------------------------- */}
                                ...
                                >
                                    {isAnalyzing ? (
                                        ...
                                        <>
                                            ...
                                            Kök Neden Analizini Başlat
                                        </>
                                    )}
                                </Button>
                                <p className="text-muted small mt-2 mb-0">
                                    Olayı analiz etmek ve Bölüm 4'ü otomatik doldurmak için tıklayın
                                </p>
                            </div>
