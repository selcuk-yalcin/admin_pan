...
import LatestTranactions from "../Dashboard/LatestTranaction";

const DashboardInvoiceBot = (props) => {
  ...
  // Invoice Bot specific reports
  const reports = [
    { title: "Total Invoices", iconClass: "bx-receipt", description: "1,235" },
    { title: "Bot Revenue", iconClass: "bx-dollar-circle", description: "$35,723" },
    { title: "Active Bots", iconClass: "bx-bot", description: "12" },
  ];
  ...
  //meta title
  document.title = "Invoice Bot Dashboard | Skote - Vite React Admin & Dashboard Template";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title={props.t("Invoice Bot")} breadcrumbItem={props.t("Dashboard")} />
              ...
              <Card>
                <CardBody>
                  <div className="d-sm-flex flex-wrap">
                    <h4 className="card-title mb-4">Invoice Bot Activity</h4>
      ...
      >
        <div>
          ...
          <ModalBody>
            <p className="mb-2">
              Invoice id: <span className="text-primary">#INV2540</span>
            </p>
            <p className="mb-4">
...
DashboardInvoiceBot.propTypes = {
  t: PropTypes.any,
  chartsData: PropTypes.any,
  onGetChartsData: PropTypes.func,
};

export default withTranslation()(DashboardInvoiceBot);
