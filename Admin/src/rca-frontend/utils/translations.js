const translations = {
  tr: {
    ...
    reports_rename_hint: 'İsmi değiştirmek için tıklayın',
    reports_rename_label: 'Rapor adı',
    ...
    reports_folder_videos: 'Videolar',
    reports_videos_sidebar_hint: 'Eğitim veya olay videolarını buraya yükleyin (bu tarayıcıda saklanır).',
    reports_drafts_sidebar_hint: 'Kaydedilmiş formlar; devam etmek için Formda aç.',
    ...
    hitl_intro_title: 'Etkileşimli derinleştirme analizi',
    ...
    hitl_determining_causes: 'Olay metni analiz ediliyor…',
  ...
  en: {
    ...
    reports_rename_hint: 'Click to rename',
    reports_rename_label: 'Report name',
    ...
    reports_folder_videos: 'Videos',
    reports_videos_sidebar_hint: 'Upload training or incident videos here (stored in this browser).',
    reports_drafts_sidebar_hint: 'Saved forms — open in the manual form to continue.',
    ...
    hitl_intro_title: 'Interactive deepening analysis',
    ...
    hitl_determining_causes: 'Reviewing incident narrative…',
